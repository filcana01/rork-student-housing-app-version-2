...
function applyTemporaryStyles(params) {
...
function applyPersistentStyles(params) {
...
function applyPermanentStyles(params) {
...
const EdgeSidebar = React.forwardRef(({ className, ...props }, ref) => (
