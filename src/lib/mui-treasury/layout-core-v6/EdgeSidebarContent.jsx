...
const StyledEdgeSidebarContent = styled("div")(({ theme }) => ({
  ...
  boxShadow: "var(--EdgeSidebarContent-shadow, var(--SidebarContent-shadow))",
  ...
  overflowX: "auto",
  flex: 1,
  position: "var(--_temporary, fixed) var(--_permanent, relative)",
...
const EdgeSidebarContent = React.forwardRef(({ className, ...props }, ref) => (
