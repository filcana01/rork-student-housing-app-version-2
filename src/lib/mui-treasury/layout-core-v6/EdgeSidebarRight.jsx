...
export function applyTemporaryRightStyles(params) {
...
export function applyPersistentRightStyles(params) {
...
export function applyPermanentRightStyles(params) {
  ...
  if ("expandOnHover" in params) {
    if (params.expandOnHover === true) {
      ...
      expandConfig = params.expandOnHover;
    }
  }
  return {
...
const EdgeSidebarRight = React.forwardRef(({ className, ...props }, ref) => (
