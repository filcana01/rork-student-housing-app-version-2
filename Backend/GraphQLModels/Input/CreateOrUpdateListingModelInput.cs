...
{
    public class CreateOrUpdateListingModelInput
    {
        public long? Id { get; set; } // QUI DEVE ESSERE NULLABLE PERCHÈ ANCORA NON ESISTE
        public long? IdCategory { get; set; }
        public long? IdFurnishingStatus { get; set; }
        //  (2. Draft, 3. Pending, 4. Active, 5. Expired)
        public long? IdListingStatus { get; set; } = 3;
